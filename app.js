...
var budgetController = (function () {
    var Expence = function(id, value, description){                       // function constructor
        this.id = id;
    ...
    var Income = function(id, value, description){                       // function constructor
        this.id = id;
        this.description = description;
        this.value = value;
    };
    ...
    return {
        addItem: function(type, des, val){
            ...
            if(type === 'exp'){
                newItem = new Expence(ID,val,des);
            }else if(type === 'inc'){
...
var UIController = (function () {
    var DOMStrings = {
        ...
        container : '.container',
        expancesPercentageLabel :'.item__percentage',
    ...
    var formatNumber = function(num, type){
        ...
        comma seperator in thousands
        ex: inc : 2345.6787 --> +2,345.68
                  2000      --> +2,000.00
        */
        ...
        type === 'exp'? sign = '-' : sign = '+';
        return (type === 'exp'? '-' : '+') + ' ' + intPart + '.' + decimalPart;
    ...
    return {
        ...
        displayPercentages : function(percentages){
            var fields = document.querySelectorAll(DOMStrings.expancesPercentageLabel);
